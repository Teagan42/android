...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value=MessageNotification.class, name=MessageNotification.TYPE),
        @JsonSubTypes.Type(value=MessageNotificationAction.class, name=MessageNotificationAction.TYPE),
})
